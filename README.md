# LeetCode Solutions — @M-YOUSUF-R

---

## How GitHub Sync works

1. **Connect your GitHub account** on browser extenstion called [leetSync](https://chromewebstore.google.com/detail/ppkbejeolfcbaomanmbpjdbkfcjfhjnd?utm_source=item-share-cb)
2. **Auto-commit** — every time you submit a solution on LeetCode, it is pushed here automatically (configurable by status).
